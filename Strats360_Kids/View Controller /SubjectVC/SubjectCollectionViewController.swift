...
class SubjectCollectionViewController: UICollectionViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.imgSubject.image = arrImgs[indexPath.row]
        cell.lblsubName.text = arrNames[0]
        // Configure the cell
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let destinationVC = sb.instantiateViewController(withIdentifier: "ChapterCollectionViewController")
